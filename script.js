...
const destvie1 = document.querySelectorAll('.destvie1');
const destvie2 = document.querySelectorAll('.destvie2');
const destvie3 = document.querySelector('.destvie3');
const destvie4 = document.querySelector('.destvie4');
const otvet2 = document.querySelectorAll('.otvet2');
const date3 = document.querySelectorAll('.date3');
const otvet3 = document.querySelectorAll('.otvet3');
const otvet3nn = document.querySelector('.otvet3nn');
const otvet3t = document.querySelectorAll('.otvet3_t');
const otvet3n = document.querySelectorAll('.otvet3_n');
const otvet3t0 = document.querySelectorAll('.otvet3_t0');
const otvet3n0 = document.querySelectorAll('.otvet3_n0');
const otvet4 = document.querySelectorAll('.otvet4');
const otvet31 = document.querySelector('.otvet31');
const otvet41 = document.querySelector('.otvet41');
...
startButton.onclick = () =>  calculation();
...
const calculation = () => {
    ...
    for (let i = 0; i <= 9; i++) {
        ...
        if (qt1[i][variant.value[1]] == 0) {
            ...
            destvie1[i].innerHTML = (qt1[i][variant.value[1]] * qt2[i][variant.value[0]]).toFixed(12);
        }
    ...
    if (otvet3[20].innerHTML >= 0.9) {
        otvet31.innerHTML = "Ч";
    } else if (otvet3[20].innerHTML >= 0.1) {
        otvet31.innerHTML = "В";
    } else if (otvet3[20].innerHTML >= 0.001) {
        otvet31.innerHTML = "С";
    } else if (otvet3[20].innerHTML >= 0.00001) {
        otvet31.innerHTML = "Р";
    } else if (otvet3[20].innerHTML >= 0.0000001) {
        otvet31.innerHTML = "К";
    } else if (otvet3[20].innerHTML < 0.0000001) {
        otvet31.innerHTML = "М";
    }

    if (otvet3[15].innerHTML > 4000) {
        otvet31.innerHTML += 4;
    } else if (otvet3[15].innerHTML > 200) {
        otvet31.innerHTML += 3;
    } else if (otvet3[15].innerHTML > 50) {
        otvet31.innerHTML += 2;
    } else {
        otvet31.innerHTML += 1;
    }
    ...
    if (otvet4[9].innerHTML >= 0.9) {
        otvet41.innerHTML = "Ч";
    } else if (otvet4[9].innerHTML >= 0.1) {
        otvet41.innerHTML = "В";
    } else if (otvet4[9].innerHTML >= 0.001) {
        otvet41.innerHTML = "С";
    } else if (otvet4[9].innerHTML >= 0.00001) {
        otvet41.innerHTML = "Р";
    } else if (otvet4[9].innerHTML >= 0.0000001) {
        otvet41.innerHTML = "К";
    } else if (otvet4[9].innerHTML < 0.0000001) {
        otvet41.innerHTML = "М";
    }

    if (level[variant.value[0]] == "незначительный") {
        otvet41.innerHTML += 1;
    } else if (level[variant.value[0]] == "серьёзный") {
        otvet41.innerHTML += 2;
    } else if (level[variant.value[0]] == "критический") {
        otvet41.innerHTML += 3;
    } else {
        otvet41.innerHTML += 4;
    }
